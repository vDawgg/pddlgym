...
class TestProver(unittest.TestCase):
    def test_prover(self):
        ...
        assignments = find_satisfying_assignments(
            kb1, [predicate0(var0), predicate0(var1), predicate0(var2)]
        )
        assert len(assignments) == 2
        ...
        assignments = find_satisfying_assignments(
            kb2, [predicate0(var0), predicate0(var1), predicate0(var2)]
        )
        assert len(assignments) == 2
        ...
        assignments = find_satisfying_assignments(
            kb3, [predicate1(var0, var1), predicate1(var1, var2)]
        )
        assert len(assignments) == 1

        assignments = find_satisfying_assignments(
            kb3, [predicate1(var0, var1), predicate1(var1, var0)]
        )
        assert len(assignments) == 0

        assignments = find_satisfying_assignments(
            kb3, [predicate1(var0, var1), predicate1(var2, var3)]
        )
        assert len(assignments) == 2
        ...
        assignments = find_satisfying_assignments(
            kb4, [predicate1(var0, var1), predicate0(var1), predicate0(var0)]
        )
        assert len(assignments) == 0
        ...
        assignments = find_satisfying_assignments(
            kb6, [predicate0(var0), predicate2(var1), predicate1(var0, var1)]
        )
        assert len(assignments) == 0
...
class TestNegativePreconditions(unittest.TestCase):
    def test_negative_preconditions(self):
        ...
        assignments = find_satisfying_assignments(
            kb, conds, allow_redundant_variables=False
        )
        assert len(assignments) == 1
