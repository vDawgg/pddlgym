...
GRID4 = np.array(
    [
        ...
        [IDX, X, X, X, X, W, W, W, W, W, W, W, X, X, W, G],
    ]
)
...
def generate_problems():
    domain = PDDLDomainParser(
        os.path.join(PDDLDIR, "hiking.pddl"),
