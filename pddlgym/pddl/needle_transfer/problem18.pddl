(define (problem NEEDLE_TRANSFER_18)
  ...
  (:objects
        ...
        red_ring green_ring blue_ring yellow_ring orange_ring purple_ring pink_ring cyan_ring magenta_ring teal_ring brown_ring gray_ring olive_ring maroon_ring navy_ring lime_ring coral_ring
  )
  ...
  (:init
    ...
    (sequence coral_ring coral_ring)
  )
