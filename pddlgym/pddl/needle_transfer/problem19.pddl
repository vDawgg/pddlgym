(define (problem NEEDLE_TRANSFER_19)
  ...
  (:objects
        ...
        red_ring green_ring blue_ring yellow_ring orange_ring purple_ring pink_ring cyan_ring magenta_ring teal_ring brown_ring gray_ring olive_ring maroon_ring navy_ring lime_ring coral_ring gold_ring silver_ring indigo_ring
  )
  ...
  (:init
    ...
    (sequence indigo_ring indigo_ring)
  )
