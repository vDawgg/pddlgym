(define (problem NEEDLE_TRANSFER_07)
  ...
  (:objects
        ...
        red_ring green_ring blue_ring yellow_ring orange_ring purple_ring
  )
  ...
  (:init
    ...
    (sequence purple_ring purple_ring)
