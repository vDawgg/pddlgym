...
(:predicates (at ?x - rover ?y - waypoint)
	     ...
	     (drop ?rover - rover)
	     (calibrate ?camera - camera ?objective - objective)
	     (take_image ?objective - objective ?camera - camera ?mode - mode)
	     (communicate_soil_data ?rover - rover ?position - waypoint)
	     (communicate_rock_data ?rover - rover ?position - waypoint)
	     (communicate_image_data ?rover - rover ?objective - objective ?mode - mode)
)
