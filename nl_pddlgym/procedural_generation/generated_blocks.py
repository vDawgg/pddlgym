...
def sample_blocks(domain, pile_heights):
    ...
    for pile_height in pile_heights:
        ...
        blocks_in_pile = [
            block_type("b{}".format(next(block_idx))) for _ in range(pile_height)
        ]
...
def generate_problems(
    ...
    domain = PDDLDomainParser(
        os.path.join(PDDLDIR, "generated_blocks.pddl"),
    ...
    for problem_idx in range(50):
        ...
        sample_problem(
            ...
            problem_outfile,
            seen_problems,
            min_num_piles=min_num_piles,
            max_num_piles=max_num_piles,
            min_num_piles_goal=min_num_piles,
            max_num_piles_goal=max_num_piles,
            min_pile_height=min_pile_height,
