...
There are 12 colored pegs with the following colors: black, blue, brown, cyan, green, orange, pink, purple, red, teal, white and yellow. The pegs are all named in the format <color>_peg. Additionally there are 8 colored rings: blue, cyan, green, orange, pink, purple, red and yellow. Similarly to the pegs, the rings are named <color>_ring.
