...
use_partial_encoding: bool = False
add_implied_preconditions: bool = True
task: Any = None
sas_file: str = ""
domain: Any = None
reorder_variables: bool = False
filter_unimportant_vars: bool = False
layer_strategy: str = ""
invariant_generation_max_time: int = 300
invariant_generation_max_candidates: int = 100000
generate_relaxed_task: bool = False
filter_unreachable_facts: bool = True
dump_task: bool = False
